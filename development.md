...
Backend API (proxied through Nginx): <http://localhost:5173/api/v1>

Automatic interactive documentation with Swagger UI (proxied): <http://localhost:5173/docs>
...
Backend (proxied): <http://localhost:5173/api/v1>

Automatic Interactive Docs (Swagger UI, proxied): <http://localhost:5173/docs>

Automatic Alternative Docs (ReDoc, proxied): <http://localhost:5173/redoc>
